...
<html>
    ...
    <body class="d-flex flex-column h-100">
        <main role="main">
            <!-- Block content -->
            <h1 class="tieu-de">THÊM TRUYỆN TRANH</h1>
            <div class="container">
                ...
                <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ml-2" id="truyen_ma" name="truyen_ma" placeholder="Mã truyện tranh" value="">
                    </div>
                    <div class="form-group">
                        <label for="truyen_ten">Tên:</label>
                        <input type="text" class="form-control ml-2" id="truyen_ten" name="truyen_ten" placeholder="Tên truyện tranh" value="">
                    </div>              
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control ml-2 col" id="truyen_theloai" name="truyen_theloai" placeholder="Thể loại truyện tranh">
                    </div>
                    <div class="form-group ">
                        <label for="truyen_tacgia">Tác giả:</label>
                        <input type="text" class="form-control ml-2 col" id="truyen_tacgia" name="truyen_tacgia" placeholder="Tác giả truyện tranh">
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-8">
                            ...
                            <textarea class="form-control col ml-2" id="truyen_mota_ngan" name="truyen_mota_ngan" placeholder="Mô tả ngắn về truyện tranh" rows="10"></textarea>
                        </div>
                    </div>
