...
<html>
    <head>
        ...
        <title>Chỉnh sửa Chapter Hình ảnh</title>
    ...
    <body class="d-flex flex-column h-100">
        <main role="main">
            <!-- Block content -->
            <!-- Form CHỈNH SỬA CHAPTER HÌNH ẢNH START -->
            <?php
            ...
            <h1 class="tieu-de">CHỈNH SỬA CHAPTER HÌNH ẢNH</h1>
            <div class="container-fluid">
                <form name="frmSua" id="frmSua" method="post" action="" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="col text-center">
                            <label for="">Hình cũ</label><br/>
                            <img src="/project-nentang/assets/uploads/<?= $hinhanhRow['chuong_hinhanh_tenhinh'] ?>" width="70%" class="img-fluid" />
                        </div>
                        <div class="col text-center">
                            <!-- Tạo khung div hiển thị ảnh cho người dùng Xem trước khi upload file lên Server -->
                            <div class="preview-img-container">
                                <img src="/project-nentang/assets/shared/img/default-image_600.png" id="preview-img" width="70%" class="img-fluid" />
                            </div>
                            <!-- Input cho phép người dùng chọn FILE 
                                Chỉ cho phép người dùng chọn các file Ảnh (*.jpg, *.jpeg, *.png, *.gif)
                            -->
                            <input type="file" class="m-2" id="chuong_hinhanh_tenhinh" name="chuong_hinhanh_tenhinh" accept=".jpg, .jpeg, .png, .gif">
                        </div>
                    </div>

                    <div class="text-right m-2">
                        <button name="btnLuu" id="btnLuu" class="btn btn-danger">Lưu</button>
                    </div>
                </form>
            </div>
            <!-- End block content -->
