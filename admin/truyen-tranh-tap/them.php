...
<head>
  ...
  <title>Thêm Chapter Truyện tranh</title>
...
<body class="d-flex flex-column h-100">
  <main role="main" class="mb-2">
    ...
    <h1 class="tieu-de">THÊM CHAPTER TRUYỆN TRANH</h1>
    <div class="container">
      <!-- Form THÊM CHAPTER TRUYỆN TRANH START -->
      <div class="row">
        <div class="col">
          ...
          <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control ml-2" id="chuong_so" name="chuong_so" placeholder="Chapter muốn thêm" value="">
              </div>
              <div class="form-group">
                <label for="chuong_ten">Tên Chapter:</label>
                <input type="text" class="form-control ml-2 col" id="chuong_ten" name="chuong_ten" placeholder="Tên Chapter Truyện tranh" value="">
              </div>
