...
<html>
    <head>
        ...
        <title>Chỉnh sửa Chapter Truyện tranh</title>
    ...
    ";
            ...
            <h1 class="tieu-de">CHỈNH SỬA CHAPTER TRUYỆN TRANH</h1>
            <div class="container">
                <!-- Form CHỈNH SỬA CHAPTER TRUYỆN TRANH START -->
                <div class="row">
                    <div class="col">
                        ...
                        <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control ml-2" id="chuong_so" name="chuong_so" placeholder="Số Chapter muốn sửa" value="<?= $chuongRow['chuong_so'] ?>">
                            </div>
                            <div class="form-group">
                                <label for="chuong_ten">Tên Chapter:</label>
                                <input type="text" class="form-control ml-2 col" id="chuong_ten" name="chuong_ten" placeholder="Tên Chapter Truyện tranh" value="<?= $chuongRow['chuong_ten'] ?>">
                            </div>
