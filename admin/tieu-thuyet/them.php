...
<html>
    <head>
        ...
        <title>Thêm mới Tiểu thuyết</title>
    ...
    <body class="d-flex flex-column h-100">
        <main role="main">
            <!-- Block content -->
            <h1 class="tieu-de">THÊM TIỂU THUYẾT</h1>
            <div class="container">        
                ...
                <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">                    
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ml-2" id="truyen_ma" name="truyen_ma" placeholder="Mã tiểu thuyết" value="">
                    </div>                  
                    <div class="for-group">
                        <label for="truyen_ten">Tên:</label>
                        <input type="text" class="form-control ml-2" id="truyen_ten" name="truyen_ten" placeholder="Tên tiểu thuyết" value="">
                    </div>
                    <div class="form-group">
                        <label for="truyen_loai">Loại:</label>
                        <input type="text" class="form-control ml-2" id="truyen_loai" name="truyen_loai" placeholder="Loại tiểu thuyết" value="#1-Tiểu thuyết" readonly>
                    </div>
                    <div class="form-group">
                        <label for="truyen_theloai">Thể loại:</label>
                        <input type="text" class="form-control ml-2 col" id="truyen_theloai" name="truyen_theloai" placeholder="Thể loại Tiểu thuyết">
                    </div>
                    <div class="form-group">
                        <label for="truyen_tacgia">Tác giả:</label>
                        <input type="text" class="form-control ml-2 col" id="truyen_tacgia" name="truyen_tacgia" placeholder="Tác giả Tiểu thuyết">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-4">
                            <label for="truyen_hinhdaidien">Hình đại diện:
                                ...
                                <div class="preview-img-container mt-2">
                                    <img src="/project-nentang/assets/shared/img/default-image_600.png" id="preview-img" width="60%" />
                                    <br />
                                ...
                                Chỉ cho phép người dùng chọn các file Ảnh (*.jpg, *.jpeg, *.png, *.gif)
                                    ...
                                    <input type="file" class="col mt-2" id="truyen_hinhdaidien" name="truyen_hinhdaidien"
                                           accesskey=""accept=".jpg, .jpeg, .png, .gif">
                                </div>
                            </label>           
                        </div>
                        <div class="form-group col-8">
                            <label for="truyen_mota_ngan">Mô tả ngắn:</label>
                            <textarea class="form-control col ml-2" id="truyen_mota_ngan" name="truyen_mota_ngan" placeholder="Mô tả ngắn về Tiểu thuyết" rows="10">                                  
                            </textarea>
                        </div>
                    </div>
...
// => giá trị của biến $errors là rỗng
            if (isset($_POST['btnLuu'])  // Nếu người dùng có bấm nút "Lưu dữ liệu"
                ...
                $upload_dir = __DIR__ . "/../../assets/uploads/tieu-thuyet/";
