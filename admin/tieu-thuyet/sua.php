...
<html>
    <head>
        ...
        <title>Chỉnh Sửa Tiểu thuyết</title>
    ...
    <body class="d-flex flex-column h-100">
        <main role="main">
            <!-- Block content -->
            <h1 class="tieu-de">CHỈNH SỬA TIỂU THUYẾT</h1>
            <div class="container">
                <!-- Form TIỂU THUYẾT START -->
                <?php
                ...
                <form name="frmSua" id="frmSua" method="post" action="" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ml-2" id="truyen_ma" name="truyen_ma" placeholder="Mã Tiểu thuyết" 
                               value="<?= $truyenRow['truyen_ma'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="truyen_ten">Tên:</label>
                        <input type="text" class="form-control ml-2" id="truyen_ten" name="truyen_ten" placeholder="Tên Tiểu thuyết" 
                    ...
                    <div class="form-row">
                        <div class="form-group col-4">
                            <label for="truyen_hinhdaidien">Hình đại diện:
                                ...
                                <div class="preview-img-container mt-2">
                                    <img src="/project-nentang/assets/uploads/tieu-thuyet/<?= $truyenRow['truyen_hinhdaidien'] ?>" id="preview-img" width="60%" />
                        ...
                        <div class="form-group col-8">
                            ...
                            <textarea class="form-control col ml-2" id="truyen_mota_ngan" name="truyen_mota_ngan" placeholder="Mô tả ngắn về Tiểu thuyết " rows="10"><?= $truyenRow['truyen_mota_ngan'] ?>
                            </textarea>
                        </div>
                    </div>
