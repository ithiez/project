...
<html>
    <head>
        ...
        <title>Chỉnh sửa Chapter Tiểu thuyết</title>
    ...
    ";
            ...
            <h1 class="tieu-de">CHỈNH SỬA CHAPTER TIỂU THUYẾT</h1>
            <div class="container">
                <!-- Form CHỈNH SỬA CHAPTER TIỂU THUYẾT START -->
                <div class="row">
                    <div class="col">
                        ...
                        <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control ml-2 col" id="chuong_ten" name="chuong_ten" placeholder="Tên Chapter Tiểu thuyết" value="<?= $chuongRow['chuong_ten'] ?>">
                            </div>
                            <div class="form-row">
                                <div class="col">
