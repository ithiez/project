...
<html>
    ...
    <head>
        ...
        <title>Nội dung Chapter Tiểu thuyết</title>
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main role="main">
            ...
            <div class="container mt-2">
                <h1 class="tieu-de">NỘI DUNG CHAPTER TIỂU THUYẾT</h1>
                ...
                <div class="row mb-2">
                    <div class="col text-center">
                        ...
                        <a href="noi-dung.php?truyen_id=<?= $truyen_id ?>&chuong_so=<?= $chuongTruocSo ?>&tong_so_chuong=<?= $tong_so_chuong ?>" 
                           class="btn btn-outline-danger fa fa-2x fa-arrow-circle-left <?= $trangThaiChuongTruoc ?>"></a>

                        <a href="chi-tiet.php?truyen_id=<?= $truyen_id ?>" class="btn btn-outline-danger fa fa-2x fa-navicon"></a>

                        <a href="noi-dung.php?truyen_id=<?= $truyen_id ?>&chuong_so=<?= $chuongSauSo ?>&tong_so_chuong=<?= $tong_so_chuong ?>" 
                           class="btn btn-outline-danger fa fa-2x fa-arrow-circle-right <?= $trangThaiChuongSau ?>"></a>
                    </div>
                </div>
