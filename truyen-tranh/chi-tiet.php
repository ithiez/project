...
<body class="d-flex flex-column h-100">
  ...
  <main role="main">
    ...
    <div class="container mt-2">
      <h1 class="tieu-de">CHI TIẾT TRUYỆN TRANH</h1>
      <?php
...
EOT;
    ...
    <div class="container">
      ...
      <!-- THÔNG TIN TRUYỆN TRANH START -->
      <div class="row">
        <div class="col col-md-4">
          <img src="/project-nentang/assets/uploads/truyen-tranh/<?= $dataTruyenRow['truyen_hinhdaidien'] ?>" class="card-img-top img-fluid" alt="">
          <p>
            <ul>
      ...
      <!-- THÔNG TIN TRUYỆN TRANH END -->

      <!-- DANH SÁCH CÁC CHƯƠNG/TẬP START -->
      <div class="row">
        <div class="col">
          <h3 class="text-truyen-tranh">DANH SÁCH CHƯƠNG</h3>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <ul>
            <?php foreach($dataChuong as $chuong): ?>
              <li>
                  <a class="text-success" href="noi-dung.php?truyen_id=<?= $truyen_id ?>&chuong_so=<?= $chuong['chuong_so'] ?>&tong_so_chuong=<?= count($dataChuong) ?>">
                  Chapter <?= $chuong['chuong_so'] ?> - <?= $chuong['chuong_ten'] ?>
                </a>
              </li>
            <?php endforeach; ?>
          </ul>
