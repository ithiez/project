    ...
    <body class="d-flex flex-column h-100 bg-light">
        ...
        <main role="main" class="">
            ...
            <div class="container mt-2 bg-white">
                <h1 class="tieu-de">WEB ĐỌC TRUYỆN TRANH VÀ TIỂU THUYẾT MIỄN PHÍ</h1>
                ...
                $sqlDanhSachTruyen = <<<EOT
                        SELECT truyen_id, truyen_ma, truyen_ten, truyen_hinhdaidien, truyen_loai, truyen_theloai, truyen_tacgia, truyen_mota_ngan, truyen_ngaydang FROM truyen;
                        EOT;
            ...
            <div class="container bg-white">
                ...
                <div class="row">
                    <div class="col">
                        <h3 class="text-truyen-tranh mt-4">TRUYỆN TRANH MỚI CẬP NHẬT</h3>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <h3 class="text-tieu-thuyet mt-4">TRUYỆN TIỂU THUYẾT MỚI CẬP NHẬT</h3>
                    </div>
                </div>
                <div class="row row-cols-5">
                    <?php foreach ($dataDanhSachTieuThuyet as $tieuthuyet) : ?>
                        <div class="col text-center">
                            <div class="card">
                                <a  href="tieu-thuyet/chi-tiet.php?truyen_id=<?= $tieuthuyet['truyen_id'] ?>">
                                    <img src="/project-nentang/assets/uploads/tieu-thuyet/<?= $tieuthuyet['truyen_hinhdaidien'] ?>" class="card-img-top img-fluid" alt="">
                                </a>                           
                            </div>
                            <div class="card-text mb-3 mt-2">
                                <a class="text-decoration-none"  href="tieu-thuyet/chi-tiet.php?truyen_id=<?= $tieuthuyet['truyen_id'] ?>">
                                    <h5 class="text-dark"><?= $tieuthuyet['truyen_ten'] ?></h5>
                                </a>
                            </div>
                        </div>
                    <?php endforeach; ?>
